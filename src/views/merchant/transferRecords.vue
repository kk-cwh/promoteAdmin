            ...
            <el-col :span="24">
                <div class="table-content">
                    <el-table border v-loading="loading" :data="tableData" row-class-name="report-row-item" cell-class-name="report-cell-item" size="mini">
                        <el-table-column prop="player_id" label="玩家ID" width="160px">
                        </el-table-column>
                        <el-table-column prop="agency_id" label="商人ID" width="160px">
                        </el-table-column>
                        <el-table-column prop="balance_before" label="转账前库存" width="160px">
                        </el-table-column>
                        <el-table-column prop="money" label="转出金币">
                        </el-table-column>
                        <el-table-column prop="balance" label="转账后库存">
                        </el-table-column>
